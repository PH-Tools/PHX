...
def test_read_default_single_zone_room():
    file_path = Path("tests", "reference_files", "from_grasshopper_tests", "hbjson", "Default_Room_Single_Zone.json")
...
def test_read_not_a_real_file():
    file_path = Path("tests", "reference_files", "from_grasshopper_tests", "hbjson", "This_file_does_not_exist.hbjson")
