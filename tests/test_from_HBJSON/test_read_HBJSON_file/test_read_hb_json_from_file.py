...
def test_read_default_single_zone_model():
    file_path = Path("tests", "_test_reference_files_hbjson", "Default_Model_Single_Zone.hbjson")
    d = read_HBJSON_file.read_hb_json_from_file(file_path)
    assert d


def test_read_default_single_zone_room():
    file_path = Path("tests", "_test_reference_files_hbjson", "Default_Room_Single_Zone.json")
...
def test_read_not_a_real_file():
    file_path = Path("tests", "_test_reference_files_hbjson", "This_file_does_not_exist.hbjson")
