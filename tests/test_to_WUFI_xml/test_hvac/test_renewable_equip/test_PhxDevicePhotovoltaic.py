...
def test_default_PhxDevicePhotovoltaic(reset_class_counters):
    ...
    assert xml_string_to_list(result) == [
        ...
        "<ArraySizePV>0</ArraySizePV>",
        "<PhotovoltaicRenewableEnergy>0</PhotovoltaicRenewableEnergy>",
        "<OnsiteUtilization>1.0</OnsiteUtilization>",
        "<AuxiliaryEnergy>0</AuxiliaryEnergy>",
        "<AuxiliaryEnergyDHW>0</AuxiliaryEnergyDHW>",
