...
@pytest.fixture
def project_from_hbjson() -> PhxProject:
...
@pytest.fixture
def project_from_wufi_xml() -> PhxProject:
    ...
    phx_project_xml = convert_WUFI_XML_to_PHX_project(wufi_xml_data)
    return phx_project_xml
