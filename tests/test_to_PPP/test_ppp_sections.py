...
def test_ppp_file_end_markers():
    sections = [
        PppSection("Flaechen_Flaecheneingabe_Bauteil_Bezeichnung", 1, 1, ["Floor"]),
        PppSection("Flaechen_Waermebrueckeneingabe_Bezeichnung", 1, 1, ["-"]),
        PppSection("Fenster_Bezeichnung_Pos", 1, 1, ["001"]),
