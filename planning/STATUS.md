...
|------|------|--------|---------|
| Psi-install bug fixes | Refactor (cross-repo) | **In progress** — Phases 1, 4, 6, and 7 complete; Phase 8 implemented, live GH check assigned to Ed | [`refactor/psi-install-bug-fixes-plan.md`](refactor/psi-install-bug-fixes-plan.md) |
