...
|------|------|--------|---------|
| Write ventilation ducting to PHPP "Addl vent" | Feature | **In progress** — row model complete; PHPP builder next | [`features/phpp-vent-ducting/`](features/phpp-vent-ducting/README.md) |
