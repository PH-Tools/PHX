...
| Project-scoped deterministic identities | Architecture feature | **In progress** — Phases 0–5 complete; HB isolation and WUFI explicit claims green, exporter validation next | [`features/project-scoped-identities/`](features/project-scoped-identities/README.md) |
