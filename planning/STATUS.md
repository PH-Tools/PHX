...
|------|------|--------|---------|
| Write ventilation ducting to PHPP "Addl vent" | Feature | **Implemented** — automated suite complete; live PHPP spot-check next | [`features/phpp-vent-ducting/`](features/phpp-vent-ducting/README.md) |
