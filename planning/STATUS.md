...
|------|------|--------|---------|
| Write ventilation ducting to PHPP "Addl vent" | Feature | **In progress** — builder complete; write-sequence wiring next | [`features/phpp-vent-ducting/`](features/phpp-vent-ducting/README.md) |
