...
| Project-scoped deterministic identities | Architecture feature | **Scoped** — audit and phased red-green TDD packet complete; sequential drift reproduced | [`features/project-scoped-identities/`](features/project-scoped-identities/README.md) |
