...
|------|------|--------|---------|
| HBJSON Space loads + utilization schedules | Bug fix | **In progress** — Phase 0 complete; Phase 1 next | [`bug-fix/hbjson-occupancy-and-schedules/`](bug-fix/hbjson-occupancy-and-schedules/README.md) |
