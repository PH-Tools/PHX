...
| Project-scoped deterministic identities | Architecture feature | **In progress** — Phase 0 leakage characterization and Phase 1 allocator primitive complete | [`features/project-scoped-identities/`](features/project-scoped-identities/README.md) |
