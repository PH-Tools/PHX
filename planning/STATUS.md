...
| Project-scoped deterministic identities | Architecture feature | **In progress** — Phases 0–2 complete; envelope/geometry migration next | [`features/project-scoped-identities/`](features/project-scoped-identities/README.md) |
