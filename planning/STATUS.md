...
|------|------|--------|---------|
| HBJSON Space loads + utilization schedules | Bug fix | **In progress** — Phases 0-3 complete; Phase 4 next | [`bug-fix/hbjson-occupancy-and-schedules/`](bug-fix/hbjson-occupancy-and-schedules/README.md) |
