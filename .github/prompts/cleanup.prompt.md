...
# Refactor the NEW code to address any of the following issues:
...
1. **Function/Component Size**
   ...
   - Where possible, implement clean-code and SOLID practices (Single-responsibility, Open-closed, etc.)
